        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="input-wrap2">
                <textarea
                  class="detail-text-area styled__Memo-sc-17hggnx-2 SAaJi"
                  name="tbContent"
...
.add-transfer .detail-contents > table th {
  min-width: 150px;
  color: rgb(34, 34, 34);
  font-size: 15px;
  font-weight: 500;
...
.add-transfer .detail-contents > table {
  width: 100%;
}

.add-transfer .detail-contents > table td {
  vertical-align: middle;
}

.add-transfer .detail-contents .detail-text-area {
  padding: 12px 16px;
  color: rgb(76, 76, 76);
  font-size: 14px;
...
.add-transfer .detail-contents .detail-input {
  padding: 0px 16px;
  color: rgb(76, 76, 76);
  font-size: 14px;
  border: 1px solid rgb(223, 223, 223);
...
.add-transfer .input-radio {
  display: block;
  position: relative;
  cursor: pointer;
}

.add-transfer .input-radio input[type="radio"] {
  width: 0px;
  height: 0px;
  opacity: 0;
  position: absolute;
...
.add-transfer .input-radio input[type="radio"]:checked + p {
  color: rgb(255, 255, 255);
  border-color: rgb(50, 108, 249);
  background-color: rgb(50, 108, 249);
}

.add-transfer .input-radio p {
  display: flex;
  -webkit-box-align: center;
  align-items: center;
...
.add-transfer .radio-list > li + li {
  margin-left: 10px;
}

.add-transfer .agree-wrap {
  display: flex;
...
.add-transfer .check-label > input[type="checkbox"] {
  margin: 0px;
  border: 0px;
  border-radius: 0px;
  background: url("@/assets/img/check_off.svg") center center / cover no-repeat
    rgb(255, 255, 255);
  appearance: none;
  cursor: pointer;
  width: 22px;
...
.add-transfer .check-label > input[type="checkbox"]:checked {
  background-image: url("@/assets/img/check_on.svg") !important;
}

.add-transfer .check-label > p {
  margin-left: 8px;
  color: rgb(34, 34, 34);
  font-size: 16px;
}

.add-transfer .btn-wrap {
  margin-top: 30px;
  text-align: center;
}
.add-transfer .btn-wrap button.cancel {
  color: rgb(34, 34, 34);
  font-size: 15px;
...
.add-transfer .btn-wrap button.add {
  color: rgb(255, 255, 255);
  font-size: 15px;
  border: 0px;
